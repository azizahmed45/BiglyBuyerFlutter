...
class TopSellerProvider extends ChangeNotifier {
  ...
  Future<void> getTopSellerList(bool reload, BuildContext context, String languageCode) async {
    if (_topSellerList.length == 0 || reload) {
      ApiResponse apiResponse = await topSellerRepo.getTopSeller(languageCode);
