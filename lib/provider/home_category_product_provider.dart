...
import 'package:bigly24/data/model/response/home_category_product_model.dart';
import 'package:bigly24/data/repository/home_category_product_repo.dart';
...
class HomeCategoryProductProvider extends ChangeNotifier {
  ...
  Future<void> getHomeCategoryProductList(bool reload, BuildContext context, String languageCode) async {
    if (_homeCategoryProductList.length == 0 || reload) {
      ApiResponse apiResponse = await homeCategoryProductRepo.getHomeCategoryProductList(languageCode);
