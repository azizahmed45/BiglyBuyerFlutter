...
import 'package:bigly24/data/model/response/featured_deal_model.dart';
...
class FeaturedDealProvider extends ChangeNotifier {
  ...
  Future<void> getFeaturedDealList(bool reload, BuildContext context, String languageCode) async {
    if (_featuredDealList.length == 0 || reload) {
      ApiResponse apiResponse = await featuredDealRepo.getFeaturedDeal(languageCode);
