...
import 'package:bigly24/data/repository/auth_repo.dart';
import 'package:bigly24/data/repository/banner_repo.dart';
import 'package:bigly24/data/repository/brand_repo.dart';
import 'package:bigly24/data/repository/cart_repo.dart';
import 'package:bigly24/data/repository/category_repo.dart';
import 'package:bigly24/data/repository/chat_repo.dart';
import 'package:bigly24/data/repository/coupon_repo.dart';
import 'package:bigly24/data/repository/featured_deal_repo.dart';
import 'package:bigly24/data/repository/flash_deal_repo.dart';
import 'package:bigly24/data/repository/notification_repo.dart';
import 'package:bigly24/data/repository/onboarding_repo.dart';
import 'package:bigly24/data/repository/product_details_repo.dart';
import 'package:bigly24/data/repository/order_repo.dart';
import 'package:bigly24/data/repository/product_repo.dart';
import 'package:bigly24/data/repository/profile_repo.dart';
import 'package:bigly24/data/repository/search_repo.dart';
import 'package:bigly24/data/repository/seller_repo.dart';
import 'package:bigly24/data/repository/splash_repo.dart';
import 'package:bigly24/data/repository/support_ticket_repo.dart';
import 'package:bigly24/data/repository/top_seller_repo.dart';
import 'package:bigly24/data/repository/wishlist_repo.dart';
import 'package:bigly24/helper/network_info.dart';
...
import 'package:bigly24/provider/chat_provider.dart';
import 'package:bigly24/provider/coupon_provider.dart';
import 'package:bigly24/provider/facebook_login_provider.dart';
import 'package:bigly24/provider/featured_deal_provider.dart';
import 'package:bigly24/provider/flash_deal_provider.dart';
import 'package:bigly24/provider/google_sign_in_provider.dart';
...
import 'package:bigly24/provider/notification_provider.dart';
import 'package:bigly24/provider/onboarding_provider.dart';
