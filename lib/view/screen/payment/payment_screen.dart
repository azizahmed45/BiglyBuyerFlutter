...
class PaymentScreen extends StatefulWidget {
  ...
  PaymentScreen({@required this.addressID, @required this.customerID, @required this.couponCode});
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    super.initState();
    selectedUrl = '${AppConstants.BASE_URL}customer/payment-mobile?customer_id=${widget.customerID}&address_id=${widget.addressID}&coupon_code=${widget.couponCode}';
    print(selectedUrl);
