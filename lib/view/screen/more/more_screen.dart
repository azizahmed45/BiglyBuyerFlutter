...
import 'package:bigly24/view/screen/chat/inbox_screen.dart';
...
import 'package:bigly24/view/screen/more/web_view_screen.dart';
import 'package:bigly24/view/screen/more/widget/app_info_dialog.dart';
import 'package:bigly24/view/screen/more/widget/html_view_Screen.dart';
import 'package:bigly24/view/screen/more/widget/sign_out_confirmation_dialog.dart';
import 'package:bigly24/view/screen/notification/notification_screen.dart';
import 'package:bigly24/view/screen/offer/offers_screen.dart';
import 'package:bigly24/view/screen/order/order_screen.dart';
import 'package:bigly24/view/screen/profile/address_list_screen.dart';
import 'package:bigly24/view/screen/profile/profile_screen.dart';
import 'package:bigly24/view/screen/setting/settings_screen.dart';
import 'package:bigly24/view/screen/support/support_ticket_screen.dart';
import 'package:bigly24/view/screen/wishlist/wishlist_screen.dart';
    ...
    return InkWell(
      ...
      child: Column(children: [
        Container(
          ...
          child: Image.asset(image, color: Theme.of(context).highlightColor),
        ),
        Align(
