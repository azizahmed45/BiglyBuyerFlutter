...
import 'package:bigly24/view/basewidget/product_widget.dart';
import 'package:bigly24/view/basewidget/title_row.dart';
import 'package:bigly24/view/screen/product/brand_and_category_product_screen.dart';
import 'package:bigly24/view/screen/product/product_details_screen.dart';
                  ...
                  return Column(
                    ...
                    children: [
                      isHomePage
                          ...
                          : SizedBox(),
                      ConstrainedBox(
                        constraints: homeCategoryProductProvider.homeCategoryProductList[index].products.length > 0 ? BoxConstraints(maxHeight: 240):BoxConstraints(maxHeight: 0),
                            ...
                            itemBuilder: (BuildContext context, int i) {
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: ProductWidget(productModel: homeCategoryProductProvider.productList[i])
