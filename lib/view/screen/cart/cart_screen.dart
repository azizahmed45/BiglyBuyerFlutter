...
import 'package:bigly24/view/screen/cart/widget/cart_widget.dart';
import 'package:bigly24/view/screen/checkout/checkout_screen.dart';
import 'package:bigly24/view/screen/checkout/widget/shipping_method_bottom_sheet.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<CartProvider>(builder: (context, cart, child) {
      ...
      for (int i = 0; i < cart.cartList.length; i++) {
        amount += (cart.cartList[i].price) * cart.cartList[i].quantity;
        discount += 0 * cart.cartList[i].quantity;
        tax += 0 * cart.cartList[i].quantity;
      }
