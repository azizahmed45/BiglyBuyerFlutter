...
import 'package:bigly24/view/basewidget/product_shimmer.dart';
import 'package:bigly24/view/basewidget/search_widget.dart';
import 'package:bigly24/view/screen/search/widget/search_product_widget.dart';
          ...
          Consumer<SearchProvider>(
            builder: (context, searchProvider, child) {
              return !searchProvider.isClear ? searchProvider.searchProductList != null ? searchProvider.searchProductList.length > 0
                  ...
                  : Expanded(child: ProductShimmer(isHomePage: false,isEnabled: Provider.of<SearchProvider>(context).searchProductList == null))
                  : Expanded(
                flex: 4,
                child: Container(
